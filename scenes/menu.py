...
class MenuScene(Scene):
    picture="/home/prom/PycharmProjects/pacman/assets/images/picture.png"
    ...
    def create_objects(self):
        ...
        self.button_start = Btn(self.game, (self.x, self.y + self.dist*0, self.l, self.h), Color.WHITE, self.font, "Запуск игры", self.blurstart)
    ...
    def blured(self, st,end,function):
        ...
        image_back.add_component(AnimationComponent(step=st, end=end, function=lambda x: shader.set_uniform("alpha", 10.0-x-self.blur), completion=function))

    def blurstart(self):
        self.blured(self.stepbl,self.endbl,self.next)
